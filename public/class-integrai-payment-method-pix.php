...
if ( class_exists( 'WC_Payment_Gateway' ) ) :
  class Integrai_Payment_Method_Pix extends WC_Payment_Gateway {
    ...
    public function __construct() {
      $this->id                 = 'integrai_pix';
      $this->has_fields         = true;
      $this->icon 	            = apply_filters('woocommerce_custom_gateway_icon', '');
      $this->title              = __( 'Integrai', 'woocommerce' );
      $this->method_title       = __( 'Integrai', 'woocommerce' );  // Title shown in admin
      $this->method_description = __( 'Método de pagamento da Integrai. Permite fazer pagamento via pix.', 'woocommerce' );  // Title shown in admin
    ...
    private function is_enabled() {
      ...
      $options  = $configHelper->get_payment_pix();
    ...
    public function init_form_fields() {
      $this->form_fields = array(
        'enabled' => array(
          ...
          'type' => 'select',
          'description' => __( 'Habilitar pagamento via Pix (Integrai)', 'woocommerce' ),
          'default' => 'yes',
          'options' => array(
            'true' => 'Sim',
            'false' => 'Não',
        ...
        'title' => array(
          ...
          'type' => 'text',
          'description' => __( 'Título que o seu cliente irá visualizar na tela de pagamento, opção pix.', 'woocommerce' ),
    ...
    public function validate_fields() {
      try {
        ...
        Integrai_Helper::log($e->getMessage(), 'Error ao validar campos no checkout de pix');
    ...
    public function process_payment( $order_id ) {
      ...
      $order->update_status('on-hold', __( 'Integrai: Aguardando pagamento do pix', 'woocommerce' ));
